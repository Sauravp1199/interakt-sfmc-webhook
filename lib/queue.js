...
const BATCH_SIZE = parseInt(process.env.QUEUE_BATCH_SIZE) || 200;
 ...
 * @param {string} primaryKeyField - Primary key field name (default: event_id - the actual SFMC primary key)
 * @returns {Promise<void>}
 */
async function enqueue(dataExtensionKey, data, primaryKeyField = 'event_id') {
    const item = {
        dataExtensionKey,
        data,
        primaryKeyField,
